 ...
 * 设置名称过滤-匹配名称开头 的对话框
 */
class SetStartMacFilterDialog(context: Context, private val bleScanner: BleScanner) :
    BaseDataBindingDialog<DialogSetStartsMacFilterBinding>(context) {
    /**
     * 设置布局
     */
    override fun setLayout(): Int {
        return R.layout.dialog_set_starts_mac_filter
    }
    ...
    private val onClickListener = View.OnClickListener {
        when (it.id) {
            binding.addNewBtn.id -> {
                showAddFilterStartsMacDialog()
                dismiss()
            }
            binding.clearBtn.id -> {
                bleScanner.clearFilterStartsAddress()
    ...
    private fun initFilterRvData() {
        ...
        stringListRecyclerViewAdapter.addData(bleScanner.getFilterStartsAddresses())
    }

    /**
     * 显示添加设备名过滤-匹配开头的对话框
     */
    private fun showAddFilterStartsMacDialog() {
        val view = View.inflate(context, R.layout.view_add_filter_starts_mac, null)
        val editText = view.findViewById<EditText>(R.id.filter_starts_mac_et)
        ...
        AlertDialog.Builder(context)
            ...
            .setPositiveButton(R.string.confirm) { _, _ ->
                ...
                bleScanner.addFilterStartsAddress(text)
    ...
    private fun showConfirmDeleteDialog(value: String) {
        AlertDialog.Builder(context)
            ...
            .setPositiveButton(R.string.confirm) { _, _ ->
                bleScanner.removeFilterStartsAddress(value)
